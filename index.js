/* Compiled by kdc on Wed Mar 26 2014 18:43:16 GMT+0000 (UTC) */
(function() {
/* KDAPP STARTS */
...
WordpressMainView = (function(_super) {
  ...
  WordpressMainView.prototype.runCallback = function() {
    var session;
  ...
  WordpressMainView.prototype.isWordpressRunning = function(callback) {
    var vmc;
    vmc = KD.getSingleton('vmController');
    return vmc.run("pgrep -f '.koding-WordPress/WordPress.js' -l -u " + (KD.nick()), function(err, res) {
